...
var CallOption_body_bytes []byte

func init() {
	CallOption_body_bytes, _ = hex.DecodeString("557a6422000000547ac6a069547a547aae7cac6900007b537a51557ac1632f000000547ac59f690000c3c251577ac1")
}
...
// MAXTIME GREATERTHAN      [... buyerSig buyerKey seller strikeCurrency strikePrice before(deadline)]
...
// MINTIME LESSTHAN         [... buyerKey seller strikeCurrency strikePrice after(deadline)]
...
func PayToCallOption(strikePrice uint64, strikeCurrency bc.AssetID, seller []byte, buyerKey ed25519.PublicKey, deadline time.Time) ([]byte, error) {
	...
	return compiler.Instantiate(CallOption_body_bytes, _contractParams,  false, _contractArgs)
}
...
func ParsePayToCallOption(prog []byte) ([][]byte, error) {
	...
	if !bytes.Equal(CallOption_body_bytes, insts[1].Data) {
