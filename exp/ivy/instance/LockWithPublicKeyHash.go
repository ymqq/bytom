...
var LockWithPublicKeyHash_body_bytes []byte

func init() {
	LockWithPublicKeyHash_body_bytes, _ = hex.DecodeString("5279aa887cae7cac")
}
...
func PayToLockWithPublicKeyHash(pubKeyHash []byte) ([]byte, error) {
	...
	return compiler.Instantiate(LockWithPublicKeyHash_body_bytes, _contractParams,  false, _contractArgs)
}
...
func ParsePayToLockWithPublicKeyHash(prog []byte) ([][]byte, error) {
	...
	if !bytes.Equal(LockWithPublicKeyHash_body_bytes, insts[1].Data) {
