...
var Escrow_body_bytes []byte

func init() {
	Escrow_body_bytes, _ = hex.DecodeString("537a641b000000537a7cae7cac690000c3c251567ac1632a000000537a7cae7cac690000c3c251557ac1")
}
...
func PayToEscrow(agent ed25519.PublicKey, sender []byte, recipient []byte) ([]byte, error) {
	...
	return compiler.Instantiate(Escrow_body_bytes, _contractParams,  false, _contractArgs)
}
...
func ParsePayToEscrow(prog []byte) ([][]byte, error) {
	...
	if !bytes.Equal(Escrow_body_bytes, insts[1].Data) {
