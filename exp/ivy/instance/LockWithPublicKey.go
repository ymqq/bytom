...
var LockWithPublicKey_body_bytes []byte

func init() {
	LockWithPublicKey_body_bytes, _ = hex.DecodeString("ae7cac")
}
...
func PayToLockWithPublicKey(publicKey ed25519.PublicKey) ([]byte, error) {
	...
	return compiler.Instantiate(LockWithPublicKey_body_bytes, _contractParams,  false, _contractArgs)
}
...
func ParsePayToLockWithPublicKey(prog []byte) ([][]byte, error) {
	...
	if !bytes.Equal(LockWithPublicKey_body_bytes, insts[1].Data) {
