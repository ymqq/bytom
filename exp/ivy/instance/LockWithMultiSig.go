...
var LockWithMultiSig_body_bytes []byte

func init() {
	LockWithMultiSig_body_bytes, _ = hex.DecodeString("537a547a526bae71557a536c7cad")
}
...
func PayToLockWithMultiSig(publicKey1 ed25519.PublicKey, publicKey2 ed25519.PublicKey, publicKey3 ed25519.PublicKey) ([]byte, error) {
	...
	return compiler.Instantiate(LockWithMultiSig_body_bytes, _contractParams,  false, _contractArgs)
}
...
func ParsePayToLockWithMultiSig(prog []byte) ([][]byte, error) {
	...
	if !bytes.Equal(LockWithMultiSig_body_bytes, insts[1].Data) {
